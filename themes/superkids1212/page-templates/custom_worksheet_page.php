...
<div class="innercnt bag_single_product worksheet_page">
  <div class="mtp">
    <?php
        $slug = $product_variations[1]['slug'];
        if(($slug == "maths-books") || ($slug == "english-books") || ($slug == "science-books")){
          echo '<h1>Superkids Worksheets for UKG / Sr. KG (4-6 years)<br> Set of 2 Workbooks</h1>';
        }else if(($slug == "english-maths-science-part-1") || ($slug == "english-maths-science-part-2")){
          echo '<h1>Superkids Worksheets for UKG / Sr. KG (4-6 years)<br> Set of 3 Workbooks</h1>';
        }else{
          echo '<h1>Superkids Worksheets for UKG / Sr. KG (4-6 years)<br> Set of 6 Workbooks</h1>';
        }
    ?>
    ...
    <div method="POST" name="bagsproduct" id="bagsproduct">
      ...
      <div class="pricewrap">
        ...
        <?php
          ...
          ?>
          <?php
            //echo "<pre>"; print_r($product_variations); exit;
            $regular_price = $product_variations[1]['regular_price'];
            $sale_price = $product_variations[1]['sale_price'];
            $discount  = ceil(($sale_price/$regular_price)*100);
          ?>
          <div class="save_price"><i>(You Save: Rs.<?php echo ($regular_price - $sale_price).' ('. $discount.'%)'?>)</i></div>
    </div>
