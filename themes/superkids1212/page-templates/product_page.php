...
<div class="innercnt">
		...
		<?php if( have_rows('products') ): ?>
			<?php while ( have_rows('products') ) : the_row(); ?>
					...
					if($link == "http://192.168.192.20/superkids/"){
						$link = site_url()."/product/superkids-league-book/?bu_name=&bu_gender=";
					}
						...
						<div class="left-slider">
							<div class="flip_wrap">
								<div class="flipbook-bg">
									<div class="slide">
										<a href="<?php echo $link; ?>"><img src="<?php  echo $image[0]; ?>" data-id="<?php echo $id; ?>"></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="rightcntlist">
						...
						<div class="pricewrap">
							...
							<?php }else { ?>
								<div class="buybtn">
								<a href="<?php echo $link; ?>" data-product_sku="" class="button add_to_cart_button product_type_simple">Buy now</a>
							</div>
							<?php } ?>
