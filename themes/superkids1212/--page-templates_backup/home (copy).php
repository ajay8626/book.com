<?php
/**
* Template Name: Home Pagesdafasd
*
*/
get_header();
session_start();
...
if(isset($_REQUEST['bu_name']) && $_REQUEST['bu_name'] != '' && isset($_REQUEST['bu_gender']) && $_REQUEST['bu_gender'] != '')
{
    ...
    if($visitors_phone != ""){
        ...
        /* if(isset($_REQUEST['rakhi'])){
            $message = "Name : " . $kids_name. "<br> Phone: " . $visitors_phone; 
            $subject = $kids_name.' : From RAKHI';
            $Host = get_option('smtp_hostname');
            $Username = get_option('smtp_username');
            $Password = get_option('smtp_password');
            if($Host != '' && $Username != '' && $Password != ''){
                
                $emails = array('jayendra@skids.in','keval@skids.in','nisha@skids.in','sachin@skids.in');
            ...
            /* $message = "Name : " . $kids_name. "<br> Phone: " . $visitors_phone. "<br> Email: " . $_SESSION['sess_visitors_email']; 
