<?php
/**
* Template Name: Bags Product Page
*
*/
...
<form name="bagspageform" class="bagspageform" action="" method="get">
	<div class="inputbox">
	...
	<input type="submit" name="submit" class="button add_to_cart_button product_type_simple" value="Buy Now"/>
</form>
</div>
</div>
