...
<div class="woocommerce-additional-fields">
	...
	$pageName = $page_url[3];
	if(($pageName != 'superhero-cape') && ($pageName != 'height-chart') && ($pageName != 'bags-product')  && ($pageName != 'worksheets') && ($pageName != 'cart')){ ?>
...
The Cutest Super Kid!'; ?>
	 <p class="form-row special_message-class form-row-wide woocommerce-validated" id="special_message_field" data-priority="">
	 	<small>Default message is written below. You can also type your own message(max 500 characters)</small>
		<textarea name="special_message" class="input-text" id="special_message" rows="2" cols="5"><?php echo $special_message; ?></textarea>
	</p><small>(Max 500 characters)</small>
</div>
