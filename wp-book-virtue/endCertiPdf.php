<?php 
	...
	if(isset($_REQUEST['submit'])) {
		...
		header('Location: admin.php?page=enddocpdf&bu_name='.$_REQUEST['bu_name'].'&bu_gender='.$_REQUEST['bu_gender']);
		exit();
	} */
?>
	...
	<div role="main" id="wpbody" style="border: 1px solid rgb(196, 196, 196); padding: 10px; margin: 20px; float: left; width: 50%;">
		<div tabindex="0" aria-label="Main content" id="wpbody-content">
			<div class="wrap">
				...
				<div class="option">
					<form name="bookvirtueform" action="admin.php?page=enddocpdf" method="post" enctype="multipart/form-data">
						<input type="hidden" name="page" value="endCertiPdf" />					
