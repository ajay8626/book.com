...
<?php 
	...
	if(isset($_POST['submit'])){ 
		...
		if(preg_match("~\bhttp://skids.in/\b~",$filename)){
			$path_replace = str_replace('http://skids.in/','/var/www/html/',$filename);
			
		} else if(preg_match("~\bhttp://www.skids.in/\b~",$filename)){
			
			$path_replace = str_replace('http://www.skids.in','/var/www/html/',$filename);
		} else if(preg_match("~\bhttp://superkidsleague.com/\b~",$filename)){
			
			$path_replace = str_replace('http://superkidsleague.com/','/var/www/html/',$filename);
		} else if(preg_match("~\bhttp://www.superkidsleague.com/\b~",$filename)){
			
			$path_replace = str_replace('http://www.superkidsleague.com/','/var/www/html/',$filename);
		}
